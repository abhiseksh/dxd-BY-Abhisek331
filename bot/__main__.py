...
def stats(update, context):
    ...
    stats = f'<b>BOT UPTIME</b>: {currentTime}\n\n' \
            f'<b>CPU UTILIZATION</b>:\n[{progress_bar(cpuUsage)}] {cpuUsage}%\n' \
            f'<b>Frequency</b>: {freqcurrent}, <b>Cores</b>: {cores}\n\n' \
            f'<b>RAM USED</b>:\n[{progress_bar(memory)}] {memory}%\n' \
            f'<b>Total</b>: {mtotal}, ' \
            f'<b>Free</b>: {mavailable}\n\n' \
            ...
            f'Download: {recv}\n' \
            f'Upload: {sent}'
    update.effective_message.reply_photo("https://telegra.ph/file/179b5233b0ef85d925a70.jpg", stats, parse_mode=ParseMode.HTML)
...
help = Telegraph(access_token=telegraph_token).create_page(
        title='Priiiiyo Mirrorbot Help',
        author_name='Priiiiyo Mirrorbot',
